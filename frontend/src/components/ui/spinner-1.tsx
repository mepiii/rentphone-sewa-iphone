// Purpose: Lightweight loading spinner used by custom UI buttons.
// Callers: components/ui/button-1.
// Deps: React, Tailwind utility classes.
// API: Spinner component with size and color props.
// Side effects: none.
