// Purpose: Animated falling pattern background for hero sections.
// Callers: Home page hero.
// Deps: framer-motion.
// API: FallingPattern component.
// Side effects: continuous CSS background animation.
...
export function FallingPattern({ color = "rgba(57,102,135,0.35)", backgroundColor = "transparent", duration = 150, blurIntensity = "1em", density = 1, className = "" }: FallingPatternProps) {
  const patterns = [235, 252, 150, 253, 204, 134, 179, 299, 215, 281, 158, 210].flatMap((y) => [
  ...
  return (
    <div className={`pointer-events-none relative h-full w-full p-1 ${className}`}>
